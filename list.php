                        ...
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item">
                                 <a href="<?= $baseUrl?>">Home <i class="fa-solid fa-angle-right"></i></a> <a href=""><?= $property['ptype_name'];?></a>
                              </li>
                           </ol>
                        </nav>
                     </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-12">
                      <?php
                      $counter = 0;
                      foreach($connect->query("SELECT * FROM properties INNER JOIN property_type ON properties.prop_type = property_type.id INNER JOIN locations ON properties.prop_location = locations.id INNER JOIN property_status ON properties.prop_status = property_status.id WHERE prop_type = '$pt_id'") as $list){
                          $isOdd = ($counter % 2 != 0);
                            $counter++;
                      ?>
                      <?php if ($isOdd): ?>
