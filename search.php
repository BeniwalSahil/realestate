...
if (isset($_POST['searchNow'])) {
    ...
    //     $whereConditions[] = "properties.prop_title LIKE :title";
    //     $queryParams['title'] = '%' . $pname . '%';
    ...
    //     $whereConditions[] = "properties.prop_builder = :type";
    //     $queryParams['type'] = $prop_builder;
    // }else{
    //     die("rao");
    // }
    ...
    //         INNER JOIN builders ON properties.prop_builder = builders.id
    ...
    // if (!empty($prop_type)) {
    //     $whereConditions[] = "properties.prop_title = :title";
    //     $queryParams[':title'] = '%' . $pname . '%';
    // }
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="inner-heading header-heading">
                ...
                <p><a href="<?= $baseUrl?>">Home <i class="fa-solid fa-angle-right"></i></a> <a href="">Searched Property</a></p>
            </div>
        </div>
      </div>
    </div>
