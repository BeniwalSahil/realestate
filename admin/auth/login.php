...
<head>
        ...
        <meta charset="utf-8" />
        <title>Login | EcoSquare - Admin Dashboard </title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="text-primary p-4">
                                            ...
                                            <p class="text-white">Sign in to continue to EcoSquare</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                <p>© <script>document.write(new Date().getFullYear())</script> EcoSquare. Crafted with <i class="mdi mdi-heart text-danger"></i> by Advert India</p>
                            </div>
                        </div>
