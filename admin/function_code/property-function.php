...
if (isset($_POST["prop_submit"])) {
   ...
   // this code basic stops the code via calabrating //
    ...
    if ($stmt1->rowCount() == 0) {
        ...
        $sql =
            "INSERT INTO properties (prop_title,prop_slug,prop_logo,prop_type,prop_url,prop_cover,prop_status,prop_tag,prop_price,prop_area,prop_location,hrera,prop_builder,prop_config,prop_site_plan,prop_location_map,prop_brochure,prop_amenities,prop_phone,prop_email,prop_whatsapp,prop_meta_title,prop_meta_keyword,prop_meta_desc,prop_desc,prop_price_list,prop_location_adv,prop_key_feature,is_featured,status,prop_payment_plan,parent_location,prop_h1_tag,sorting,releated_props)VALUES (:propTitle,:propSlug,:propLogo,:propType,:propUrl,:propCoverimg,:propStatus,:propTag,:propPrice,:propArea,:propLocation,:propHrera,:propBuilder,:propConfig,:propSite,:propLocationMap,:propBroc,:propAmenities,:propPhone,:propEmail,:propWhats,:prop_meta_title,:prop_meta_keyword,:metaDesc,:propDesc,:propertyPrice,:locationAdvantage,:keyFeature,:isFeature,:status,:paymentPlan,:parentLocation,:h1tag,:sort,:releated_props)";
