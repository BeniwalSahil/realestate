   ...
   if ($_FILES["home_about_image"]["name"] !== "") {
    ...
    if(isset($_POST['home_about_update'])){ 
          ...
          if ($_FILES["home_about_image"]["name"] !== "") {
            ...
            $sql = "UPDATE home_about SET about_image=:about_image, about_image_text=:about_image_text, about_image_alt=:about_image_alt,about_image_alt=:about_image_alt,home_about_image_head=:home_about_image_head,status=:status WHERE id=:id";
            $stmt = $connect->prepare($sql);
