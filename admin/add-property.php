               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select id="parentlocation" name="parentlocation" class="form-select">
                           <option value="1">Choose...</option>
                           
                           <?php 
                             foreach($connect->query("SELECT * FROM locations WHERE parent_loct = '1'") as $loct){
                           ?>
                           <option value="<?= $loct['id']?>"><?= $loct['loct_name']?></option>
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select class="form-select" id="prop_location" name="prop_location">
                           <option>Choose</option>
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="9999445527" readonly name="prop_phone" placeholder="Enter Phone">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="formrow-lastname-input" class="form-label">Email</label>
                        <input type="text" class="form-control" value="info@ecosquare.com" disable readonly name="prop_email" placeholder="Enter Email">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="formrow-lastname-input" class="form-label">Whatsapp</label>
                        <input type="text" class="form-control" value="9999445527" readonly name="prop_whats" placeholder="Enter Whatsapp">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control"   name="sort" placeholder="Enter Sorting Number">
                     </div>
                     </div>
                     </div>
