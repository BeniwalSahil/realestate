                   ...
                   <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select id="parentlocation" name="parentlocation" class="form-select">
                           ...
                           <option value="<?= $loct['id']?>" <?php  echo $loct['id'] == $propData['parent_location'] ? 'selected' : ''; ?>><?= $loct['loct_name']?></option>
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select class="form-select" id="prop_location" name="prop_location">
                           ...
                           <?php 
                           $par_loct = $propData['parent_location'];
                             foreach($connect->query("SELECT * FROM locations WHERE parent_loct = '$par_loct'") as $loctmain){
                           ?>
                           
                           <option value="<?= $loctmain['id']?>" <?php  echo $loctmain['id'] == $propData['prop_location'] ? 'selected' : ''; ?>><?= $loctmain['loct_name']?></option>
                  ...
                  <div class="col-md-12">
                   ...
                   <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= $propData['sorting'] ?>"  name="sort" placeholder="Enter Sorting Number">
                     </div>
                     </div>
                      <div class="col-md-6">
                      <div class="mb-3">
