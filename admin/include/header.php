...
$baseUrl = "https://ecosquare.advertindia.co.in/admin/";
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.php" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="<?= $baseUrl?>assets/images/logo/ECOSQUARE-LOGO (1).png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?= $baseUrl?>assets/images/logo/ECOSQUARE-LOGO (1).png" alt="" style="height: 66px;
    background: white;
    padding: 4px;
    border-radius: 3px;
    margin-top: 16px;">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <!--    alt="Header Avatar">-->
                                <span class="d-none d-xl-inline-block ms-1" key="t-henry">EcoSquare</span>
